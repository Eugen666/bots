...
# Указываем токен
bot = telebot.TeleBot('6137656883:AAHz462T6Z4j4ORcSfsDTtBnDAAvGAnZtZg')
...
def get_text_messages(message):
    # Пишем приветствие
    bot.send_message(message.from_user.id, "😁 HII, сейчас я расскажу тебе гороскоп на сегодня.")
    # Готовим кнопки
